...
def create_course_docs(xml_path):
    logging.info("create course docs %s !!!", xml_path)
    cosmosdb_database_id = "phil-unistats"
    cosmosdb_collection_id = "courses2"
    ...
    for institution in root.iter('INSTITUTION'):
        ...
        for course in institution.findall('KISCOURSE'):
            ...
            print(course_count)
    print(
        f"Loaded {course_count} documents into collection {cosmosdb_collection_id}")
